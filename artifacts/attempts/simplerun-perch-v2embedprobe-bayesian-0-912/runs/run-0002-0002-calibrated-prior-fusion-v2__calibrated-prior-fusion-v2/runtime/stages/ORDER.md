# Lifecycle run-0002-0002-calibrated-prior-fusion-v2__calibrated-prior-fusion-v2

- Run id: `run-0002-0002-calibrated-prior-fusion-v2`
...
1. `codegen` | status=`completed` | canonical_dir=`06-codegen__*` | artifact=`06-codegen__noop`
2. `critic` | status=`completed` | canonical_dir=`07-critic__*` | artifact=`07-critic__approved`
3. `validate` | status=`not_required` | canonical_dir=`08-validate__*` | artifact=`08-validate__not-required`
