# Evidence Bundle run-0004-0003-class-coverage-fix-resolve-23-unfitted-classes

- Work item: `workitem-0003-class-coverage-fix-resolve-23-unfitted-classes`
- Experiment: `exp-0003-class-coverage-fix-resolve-23-unfitted-classes`
- Run status: `succeeded`
- Primary metric: `val_soundscape_macro_roc_auc=0.6726994510451058`
...
- soundscape_macro_roc_auc=0.997218 (full-pipeline resubstitution)
- oof_probe_macro_roc_auc=0.520275
- padded_cmap=0.057053
### Holdout Validation (sites: S03, S08, S13, S19)
- Train: 47 files (564 windows)
- Val: 12 files (144 windows)
- val_soundscape_macro_roc_auc=0.672699
- val_prior_fusion_macro_roc_auc=0.662212
- Val fitted classes: 51

## Observation Atoms
- `primary_metric` | `grounded` | val_soundscape_macro_roc_auc recorded for run-0004-0003-class-coverage-fix-resolve-23-unfitted-classes
