...
2. `evidence` | status=`completed` | canonical_dir=`01-evidence__*` | artifact=`01-evidence__succeeded`
...
6. `plan` | status=`completed` | canonical_dir=`05-plan__*` | artifact=`05-plan__submission-candidate`
7. `codegen` | status=`completed` | canonical_dir=`06-codegen__*` | artifact=`06-codegen__noop`
8. `critic` | status=`completed` | canonical_dir=`07-critic__*` | artifact=`07-critic__approved`
9. `validate` | status=`validated` | canonical_dir=`08-validate__*` | artifact=`08-validate__validated`
10. `submission` | status=`completed` | canonical_dir=`09-submission__*` | artifact=`09-submission__candidate-created`
