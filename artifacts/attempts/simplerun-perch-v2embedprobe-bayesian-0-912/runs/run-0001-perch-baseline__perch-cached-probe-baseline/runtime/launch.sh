...
export KAGGLE_AGENT_WORK_ITEM_ID=workitem-perch-baseline
export KAGGLE_AGENT_EXPERIMENT_ID=exp-perch-baseline
export KAGGLE_AGENT_RUN_ID=run-0001-perch-baseline
export KAGGLE_AGENT_RUN_DIR=/home/staff/jiayining/kaggle/worktrees/kaggle-agent-branch-search/artifacts/attempts/simplerun-perch-v2embedprobe-bayesian-0-912/runs/run-0001-perch-baseline__perch-cached-probe-baseline/runtime
export KAGGLE_AGENT_SPEC_ID=spec-0001
