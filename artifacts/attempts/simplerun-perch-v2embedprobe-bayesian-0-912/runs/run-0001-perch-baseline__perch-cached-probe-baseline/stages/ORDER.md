...
6. `plan` | status=`planned` | canonical_dir=`05-plan__*` | artifact=`05-plan__planned`
7. `codegen` | status=`generated` | canonical_dir=`06-codegen__*` | artifact=`06-codegen__generated`
