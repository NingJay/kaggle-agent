# Evidence Bundle run-0003-0002-pseudo-label-unfitted-classes-from-bayesian-prior

- Work item: `workitem-0002-pseudo-label-unfitted-classes-from-bayesian-prior`
- Experiment: `exp-0002-pseudo-label-unfitted-classes-from-bayesian-prior`
- Run status: `succeeded`
- Primary metric: `val_soundscape_macro_roc_auc=0.6650530943368517`
...
- Delta vs leader: -0.007614
- Delta vs parent: +0.000131
...
- soundscape_macro_roc_auc=0.991785 (full-pipeline resubstitution)
- oof_probe_macro_roc_auc=0.519679
- padded_cmap=0.062487
### Holdout Validation (sites: S03, S08, S13, S19)
- Train: 47 files (564 windows)
- Val: 12 files (144 windows)
- val_soundscape_macro_roc_auc=0.665053
- val_prior_fusion_macro_roc_auc=0.662212
- Val fitted classes: 34

## Observation Atoms
- `primary_metric` | `novel` | val_soundscape_macro_roc_auc recorded for run-0003-0002-pseudo-label-unfitted-classes-from-bayesian-prior
- `root_cause` | `novel` | The notebook-derived Bayesian prior + embedding probe pipeline is live; next steps are submission bundle parity and calibration.
