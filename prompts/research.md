...
Turn the current result into adopt-now, consider, and reject guidance. Prioritize root-cause repair first.

Rules:
- Convert retrieved knowledge into structured priors instead of generic summaries.
